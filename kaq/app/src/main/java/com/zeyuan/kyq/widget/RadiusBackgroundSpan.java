...
public class RadiusBackgroundSpan extends ReplacementSpan {
     ...
     * @param color     背景颜色
     * @param radius    圆角半径
     * @param paddingBP 背景的bottom和top的内边距
     */
    public RadiusBackgroundSpan(int color, int radius, int paddingBP) {
        mColor = color;
        mRadius = radius;
        this.paddingBP = paddingBP;
    }
    ...
    public void draw(Canvas canvas, CharSequence text, int start, int end, float x, int top, int y, int bottom, Paint paint) {
        ...
        RectF oval = new RectF(x, y + paint.ascent() - paddingBP, x + mSize, y + paint.descent() + paddingBP);
