 ...
 */
public class ZYWheelView extends View {
    ...
    public ZYWheelView(Context context) {
        this(context, null);
    }

    public ZYWheelView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ZYWheelView(Context context, AttributeSet attrs, int defStyleAttr) {
