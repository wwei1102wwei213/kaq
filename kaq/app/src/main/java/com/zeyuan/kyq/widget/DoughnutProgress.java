...
public class DoughnutProgress extends View {
    ...
    private static final int RED = 12, GREEN = 212, BLUE = 199; //基础颜色，这里是橙红色
    private static final int MIN_ALPHA = 30; //最小不透明度
    private static final int MAX_ALPHA = 255; //最大不透明度
    private static final float doughnutRaduisPercent = 0.88f; //圆环内圆半径占View最大半径的百分比
   ...
   // private static final float WAVE_WIDTH = 25f; //波纹圆环宽度
