...
public class SwipeFlingAdapterView extends BaseFlingAdapterView {
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        try {
            ...
            ExceptionUtils.ExceptionSend(e,"SwipeFlingAdapterView onLayout");
        }
    }
    ...
    private void layoutChildren(int startingIndex, int adapterCount) {
        try {
            ...
            ExceptionUtils.ExceptionSend(e,"layoutChildren");
        }
    ...
    private void makeAndAddView(View child) {
        try {
            ...
            if (lp == null) LogCustom.i("ZYS","lp为空");
            ...
            ExceptionUtils.ExceptionSend(e,"makeAndAddView");
        }
    }
    ...
    private void setTopView() {
        try {
            ...
            ExceptionUtils.ExceptionSend(e,"setTopView");
        }
    }
    ...
    public void setAdapter(Adapter adapter) {
        try {
            ...
            ExceptionUtils.ExceptionSend(e,"setAdapter");
        }
    }
