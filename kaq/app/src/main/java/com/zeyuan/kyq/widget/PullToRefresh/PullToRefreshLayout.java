...
//    private View pullView;
    ...
    private TextView refreshingTime;
...
//                pullUpView.clearAnimation();
    ...
    private void initTime(){
        if(!TextUtils.isEmpty(timeMills)){
            refreshingTime.setVisibility(View.VISIBLE);
            refreshingTime.setText("最后刷新时间:" + DataUtils.showFormatTimeSecond(timeMills));
        }else {
            refreshingTime.setVisibility(View.GONE);
        }
    }
     ...
     */
    public void refreshFinish(int refreshResult,boolean holdFlag) {
...
//                refreshStateImageView.setVisibility(View.VISIBLE);
                ...
                timeMills = System.currentTimeMillis()/1000 + "";
...
//                refreshStateImageView.setBackgroundResource(R.drawable.refresh_failed);
     ...
     * @param refreshResult PullToRefreshLayout.SUCCEED代表成功，PullToRefreshLayout.FAIL代表失败
     */
    public void loadmoreFinish(int refreshResult,boolean holdFlag) {
...
//                loadStateImageView.setBackgroundResource(R.drawable.load_succeed);
            ...
            case LOADING_MAX:
                // 没有更多了
//                loadStateImageView.setVisibility(View.VISIBLE);
                loadStateTextView.setText(R.string.load_max);
...
//                loadStateImageView.setBackgroundResource(R.drawable.load_failed);
     ...
     * @param refreshResult PullToRefreshLayout.SUCCEED代表成功，PullToRefreshLayout.FAIL代表失败
     */
    public void loadmoreFinish(final int refreshResult,boolean holdFlag, final boolean isSv) {
        loadingView.clearAnimation();
        loadingView.setVisibility(View.GONE);
        switch (refreshResult) {
            case SUCCEED:
                ...
                new Handler() {
                    ...
                    public void handleMessage(Message msg) {
                        ...
                        if (msg.what==0){
                            changeState(DONE);
                            hide();
                            if (isSv&&refreshResult==SUCCEED&&pullableView!=null){sendEmptyMessageDelayed(1,150);}
                        }else if(msg.what==1){
                            try {
                                int svh = ((ScrollView)pullableView).getScrollY();
                                ((ScrollView) pullableView).scrollTo(0, svh + loadStateTextView.getMeasuredHeight()+60);
                            }catch (Exception e){
                                ExceptionUtils.ExceptionSend(e,"位移出错");
                            }
                        }
                    }
                }.sendEmptyMessageDelayed(0, 1000);
...
//        pullView = refreshView.findViewById(R.id.pull_icon);
        ...
        refreshingTime = (TextView)refreshView.findViewById(R.id.state_time_tv);
