 ...
 */
public abstract class BaseHomeNoDestroyFragment extends Fragment {
    ...
    protected HomePageCallBack mHomeCallBack;

    public void setHomeCallBack(HomePageCallBack mHomeCallBack) {
        this.mHomeCallBack = mHomeCallBack;
    }
    ...
    public BaseHomeNoDestroyFragment(){}
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        boolean first = bundle.getBoolean("IsFirst",false);*/
...
//        LogCustom.d("TAG", "fragment->setUserVisibleHint 视图可见");
        /*if (getUserVisibleHint()) {
            ...
            LogCustom.d("TAG", "fragment->setUserVisibleHint 视图不可见");
            isVisible = false;
            onInvisible();
        }*/
    }
    ...
    public abstract boolean isTopFlag();
