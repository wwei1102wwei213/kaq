 ...
 */
public class ForumRefreshListView extends ListView implements AbsListView.OnScrollListener {

    private static final String TAG = "ForumRefreshListView";
    ...
    public ForumRefreshListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initHeaderView();
        initFooterView();
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE :
                ...
                int paddingTop = -headerViewHeight + diff - 260;
