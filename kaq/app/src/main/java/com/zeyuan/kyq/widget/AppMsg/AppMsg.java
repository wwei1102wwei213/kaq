...
package com.zeyuan.kyq.widget.AppMsg;
...
public class AppMsg {
     ...
     * stacking on top of any other  with this duration.</p>
     *
     * <p><b>Note</b>: You are responsible
     * for calling {@link #cancel()} on such .</p>
     *
     * @see #setDuration
     */
    ...
    /**
     * Make a {@link AppMsg} with a custom layout. The layout must have a {@link TextView} com id
     *
     * @param context The context to use. Usually your
     *                {@link Activity} object.
     * @param text    The text to show. Can be formatted text.
